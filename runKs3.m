function runKs3(startingDirectory, configFileName, fileType)
    %RUNKS Batch sorting using Kilosort
    ...
    % Kilosort location
    kilosortDirectory = '/home/kimd/Dropbox/src/Kilosort';
    ...
    for iFile = 1:nFile
        ...
        if exist(fileList{iFile}, 'file') == 2
            ...
            if doSort
                ...
                disp(['==== ', datestr(datetime, 'yyyy/mm/dd HH:MM:ss'), ', spike extraction']);
                [rez, st3, tF] = extract_spikes(rez);

                disp(['==== ', datestr(datetime, 'yyyy/mm/dd HH:MM:ss'), ', initial clustering']);
                rez = template_learning(rez, tF, st3);
                
                disp(['==== ', datestr(datetime, 'yyyy/mm/dd HH:MM:ss'), ', template matching']);
                [rez, st3, tF] = trackAndSort(rez);

                disp(['==== ', datestr(datetime, 'yyyy/mm/dd HH:MM:ss'), ', final clustering']);
